...
urlpatterns = [
    ...
    # tag urls
    path("folder/<slug:slug>/tag/make/", views.FolderTagCreateView.as_view()),
    path("folder/<slug:slug>/tag/<pk>/delete/", views.FolderTagDeleteView.as_view()),
    path("folder/tag/<slug:slug>/", views.FolderPublicFilteredByTag.as_view()),
    path("folder/tag/<slug:slug>/mine/", views.FolderPrivateFilteredByTag.as_view()),
